    ...
    <div class="container">
		...
		if (mysqli_num_rows($result) > 0) {
			...
			while($row = mysqli_fetch_assoc($result)) {
				...
				echo "<h3>" . $row["airline"] . " " . $row["flight_number"] . "</h3>";
				echo "<p>From: " . $row["departure"] . "</p>";
				echo "<p>To: " . $row["arrival"] . "</p>";
				echo "<p>Departure: " . $row["departure_date"] . " " . $row["departure_time"] . "</p>";
